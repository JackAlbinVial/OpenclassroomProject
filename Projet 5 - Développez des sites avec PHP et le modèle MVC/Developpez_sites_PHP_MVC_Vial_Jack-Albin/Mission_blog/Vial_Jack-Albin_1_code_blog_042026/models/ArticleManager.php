...
class ArticleManager extends AbstractEntityManager
{
    ...
    {
        $allowedSorts  = ['title', 'vues', 'date_creation', 'nb_comments'];
    ...
    /**
     * Méthode pour compter le nombre de vues de chaque article
     * @param int $id : l'id de l'article
     * @return void le nombre de vue est stockée en bdd
     */
