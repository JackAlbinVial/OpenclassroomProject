...
Create Database if not exists `blog_forteroche`;
Use `blog_forteroche`;
-- --------------------------------------------------------
...
INSERT INTO `article` (`id`, `id_user`,`vues`, `title`, `content`, `date_creation`, `date_update`) VALUES
